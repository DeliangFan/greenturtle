...
趋势策略普遍痛点是交易胜率低、回撤大、周期长、业绩曲线不够平滑。
...
长周期周期参数近 20 年在 CN 和 US 回测结果如下，收益未考虑除保证金以外资金带来的固定收益。

|    | 时间   | 年化  | 最大回撤 | 夏普率  | 最长不盈利(年) | 说明 |
|----|------|-----|------|------|----------|-------------------------------------|
| CN | 近20年 | 25% | 37%  | 0.91 | 3.5      | 上文参数, 10、100 日均线，50 日通道突破，100 日 ATR |
| US | 近20年 | 10% | 31%  | 0.62 | 2        | 上文参数, 10、100 日均线，50 日通道突破，100 日 ATR |


Q：国际 Barclay BTOP50 CTA Index 近 20 年表现？

A：年化收益在 6% 左右，最大回撤在 10~20%。

Q：中国头部私募 5-10 年 CTA 代表投资产品表现如何？
...
上文已给出候选品种，总体流动性不错，成交量分布为

| 主力合约成交量(手) | 农产品  | 金属  | 能源  | 指数 |
|------------|------ | ----- | ----- | ------ |
| < 1000     |       |     |  |  极少量：TL | 
| < 5000     | 极少量：CJ | 极少量：NI | 极少量：BR | 少量：TL<br>极少量：TS |
| < 10000    | 少量：CJ<br>极少量：LH| 少量：PS<br>极少量：AO、J、NI、SI | 少量：BR | 少量：IC、IH、IM、TL<br>极少量：EC、IF、TS |

保证金分布为

| 每手保证金(元) | 农产品  | 金属  | 能源  | 指数 | 一手天级波动（元） |
|------------|------ | ----- | ----- | ------ | ---- |
| 10w <  |  |  |  | 15w：IC、IF、IM<br>10w：IH | 2w |
| 5w ~ 10w |  |  | 8w: AU |  | 1w |
| 2w ~ 5w |  | 3w：J、SN、CU |  | 4w：TL<br>2w：T、EC | 3k ~ 5k |
| 1w ~ 2w | 2w：LH<br>1w+：AP | 1w+：PS、ZN、NI、AG | 1w+：NR、RU | 1w+: TF、TS| 1k ~ 2k |
| 5k ~ 1w | 7k：P<br>6k：OI | 9k：PB、AL<br>8k：JM、I<br>6k：AO | 6k：SH、PG、BR | | 0.8k ~ 1.5k |
| 0k ~ 5k | 5k：CJ、CF、Y<br>4k：SR<br>3k：PK、A<br>2k：RM、M、JD、CS、C | 5k：SS<br>3k：SM<br>2k：RB、HC | 5k：SP<br>3k：LU、UR、SA、PX、PP、L、EG、EB、FU、BU<br>2k：PF、MA、FG、V | | 0.3k ~ 0.8k |
...
通过组合不同周期，预计可以进一步提升夏普率，组合的前提是扩容 2~3 倍的资金。

### 资金

理想仓位是可以交易所有品种，假定单品种风险因子为 0.002，考虑到所有股指期货，比较理想的资金应该是 1 千万；如果再运行 3 套策略，3 千万是最为理想的资金，该资金规模下，预计需要优化下单算法，降低冲击和滑点。

250 万资金基本可以覆盖大部分品种，属于最基础的长期资金要求，此时需要限定在股指期货的数量。

20 万作为初始灰度资金，单品种风险因子需调至 0.005，可交易品种仅限低于 8k 保证金。
