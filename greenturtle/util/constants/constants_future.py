...
AGRICULTURE = {
    "CT": {
        YAHOO_CODE: "CT=F",
        CONTRACT_UNIT: 500,
        MARGIN_REQUIREMENT_PERCENT: 0.1,
        DESCRIPTION: "Cotton",
    },  # 棉花
    "ZC": {
        YAHOO_CODE: "ZC=F",
...
CRYPTO = {
    "BTC": {
        YAHOO_CODE: "BTC=F",
        CONTRACT_UNIT: 5,
        MARGIN_REQUIREMENT_PERCENT: 0.25,
        DESCRIPTION: "Bitcoin",
    },
    "ETH": {
        YAHOO_CODE: "ETH=F",
...
INTEREST_RATES = {
    "ZB": {
        YAHOO_CODE: "ZB=F",
        CONTRACT_UNIT: 1000,
        MARGIN_REQUIREMENT_PERCENT: 0.8,
        DESCRIPTION: "U.S. Treasury Bond Futures",
    },
    "ZN": {
        YAHOO_CODE: "ZN=F",
        CONTRACT_UNIT: 1000,
        MARGIN_REQUIREMENT_PERCENT: 0.6,
        DESCRIPTION: "10-Year T-Note Futures",
    },
    "ZT": {
        YAHOO_CODE: "ZT=F",
        CONTRACT_UNIT: 2000,
        MARGIN_REQUIREMENT_PERCENT: 0.4,
